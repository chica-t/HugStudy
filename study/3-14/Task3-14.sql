...
SELECT TBL1.store_name,TBL2.goods_name, TBL3.quantity FROM stock_table TBL3 
JOIN store_table TBL1 ON TBL1.store_code = TBL3.store_code 
JOIN goods_table TBL2 ON TBL2.goods_code = TBL3.goods_code;
...
INSERT INTO goods_table VALUES ('M001','マフラー',4500,'2025-03-10');
...
UPDATE stock_table SET quantity = quantity+10 WHERE goods_code = 'S987' AND store_code = 'EA01';
